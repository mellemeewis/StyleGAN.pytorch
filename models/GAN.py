...
class StyleGAN:
    ...
    def optimize_generator_and_encoder(self, z_distr, noise_distr, z, noise, real_batch, depth, alpha, betas=[0.001,0.1,0.001,0.001,0.0005,0.0005,0.0005,1,1]):
        """
        ...
        for current_depth in range(start_depth, self.depth):
            ...
            for epoch in range(1, epochs[current_depth] + 1):
                ...
                for (i, (batch,_)) in enumerate(data, 1):
                    ...
                    noise_sample = [self.noise_channel_dropout(n) for n in noise]
                    ...
                    if i % int(total_batches / feedback_factor + 1) == 0 or i == 1:
                        ...
                        with torch.no_grad():
                            ...
                            try:
                                s = "Elapsed: [%s] Step: %d  Batch: %d  D_Loss: %f  AD_Loss: %f, KL_Loss: %s, ReconLoss: %f" % (elapsed, step, i, dis_loss, adv_loss, kl_loss, recon_loss)
